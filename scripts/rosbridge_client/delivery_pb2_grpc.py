...
class DeliveryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateDelivery = channel.unary_unary(
                '/ros2_sdk.delivery.DeliveryService/CreateDelivery',
...
def add_DeliveryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ros2_sdk.delivery.DeliveryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ros2_sdk.delivery.DeliveryService', rpc_method_handlers)
